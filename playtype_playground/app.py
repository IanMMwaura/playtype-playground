...
page_metadata = ui.head_content(
    ...
    ui.tags.meta(property="og:image", content=f"{CANONICAL_URL}social-preview.png?v=2"),
    ...
    ui.tags.meta(
        ...
        content="Playtype Playground logo and wordmark",
    ),
    ...
    ui.tags.meta(name="twitter:image", content=f"{CANONICAL_URL}social-preview.png?v=2"),
    ui.tags.meta(
