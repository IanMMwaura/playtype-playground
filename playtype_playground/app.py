...
page_metadata = ui.head_content(
    ...
    ui.tags.meta(property="og:image", content=f"{CANONICAL_URL}social-preview.png"),
    ui.tags.meta(property="og:image:type", content="image/png"),
    ui.tags.meta(property="og:image:width", content="1200"),
    ui.tags.meta(property="og:image:height", content="630"),
    ui.tags.meta(
        property="og:image:alt",
        content="Playtype Playground NBA analytics dashboard preview",
    ),
    ...
    ui.tags.meta(name="twitter:image", content=f"{CANONICAL_URL}social-preview.png"),
    ui.tags.meta(
